...
![Build Status](https://github.com/Vishal-seehra/devops-capstone-project/actions/workflows/ci-build.yaml/badge.svg)
...
This is the capstone project for the IBM DevOps and Software Engineering Professional Certificate. It involves building, testing, and deploying a microservices-based application using CI/CD pipelines, Docker, and Kubernetes.
